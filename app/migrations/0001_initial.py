...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='parameters',
            field=models.ManyToManyField(through='app.ProductsParameters', to='app.parameter', verbose_name='Параметры'),
        ),
        migrations.AddField(
            model_name='productinfo',
            name='product',
        ...
        migrations.AddField(
            model_name='product',
            name='categories',
            field=models.ManyToManyField(blank=True, through='app.ProductsCategories', to='app.category'),
        ),
        migrations.CreateModel(
            name='OrderItem',
            fields=[
        ...
        migrations.AddField(
            model_name='user',
            name='company',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.shop', verbose_name='Компания'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
