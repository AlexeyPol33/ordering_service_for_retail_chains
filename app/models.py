...
class ProductInfo(models.Model):
    ...
    price_rrc = models.FloatField(
        verbose_name='разрешенная розничная цена без НДС ',
        default=0
        )
    ...
    def add_parameter(self, parameter, value=None):
        ...
        if value:
            products_parameter = ProductsParameters.\
                objects.get(parameter=parameter, product_info=self)
